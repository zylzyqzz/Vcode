...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — Vcode end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "vcode", "path to the vcode binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 Vcode e2e benchmark\n\n")
