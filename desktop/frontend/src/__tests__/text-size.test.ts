...
eq(nextTextSize("xlarge", 1), "xxlarge", "increase from xlarge");
eq(nextTextSize("xxlarge", 1), "xxlarge", "increase clamps at largest");
eq(nextTextSize("xxlarge", -1), "xlarge", "decrease from xxlarge");
