...
const STORAGE_KEY = "vcode.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["vcode.sidebar.width"],
  sidebarWidthGraphite: [],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["vcode.workspaceTree.width"],
  composerHeight: ["vcode.composerHeight"],
  drawerWidth: ["vcode.drawer.width"],
  settingsDrawerWidth: ["vcode.settingsDrawer.width"],
};
