// Command vcode-desktop is the Wails shell around the Vcode kernel: a native
...
// a nested module (vcode/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/vcode does — boot.Build resolves providers/tools from these registries.
...
// mirroring cmd/vcode/main.go. The auto-updater reads it (App.Version) to compare
...
const (
	disableWebview2GPUEnv  = "VCODE_DESKTOP_DISABLE_WEBVIEW2_GPU"
