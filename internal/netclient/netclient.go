// Package netclient builds HTTP clients and proxy resolvers that share Vcode's
...
// NewHTTPClient returns an HTTP client with Vcode proxy settings applied.
