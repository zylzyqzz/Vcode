...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/VCODE.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "VCODE.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "VCODE.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "VCODE.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "VCODE.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportResolutionRejectsEscapes(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "VCODE.md"), "Top\n@/abs/path.md\n@~/secret.md\n@../secret.md\nBottom")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "VCODE.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "VCODE.md"), "@cycle1.md")
