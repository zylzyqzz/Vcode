...
// $LC_ALL / $VCODE_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that VCODE_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("VCODE_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("VCODE_LANG=en overriding LANG=zh: got %q, want en", got)
	}
