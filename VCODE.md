...
agent. It is the Vcode analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `Vcode.md` (this file, committed/shared), `Vcode.local.md`
  (personal, git-ignored), user-global `~/.config/Vcode/Vcode.md`, and any
  `Vcode.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
